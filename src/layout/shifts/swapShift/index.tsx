...
import { useGetUsersQuery } from "@src/store/apis";
import Select from "@mui/material/Select";
import MenuItem from "@mui/material/MenuItem";
import InputLabel from "@mui/material/InputLabel";
import Divider from "@mui/material/Divider";
import Box from "@mui/material/Box";
import { OmitAssignment } from "../utils";
import { useSwapRequestMutation } from "@src/store/apis/swap";

type SwapShiftModalProps = {
  open: boolean;
  handleClose: () => void;
  shift?: OmitAssignment;
};

export const SwapShiftModal = ({
  open,
  shift,
  handleClose,
}: SwapShiftModalProps) => {
  ...
  const { mutateAsync: swapRequest, isPending: isSwapRequestLoading } =
    useSwapRequestMutation();

  const handleAssignSkill = () => {
    swapRequest({ targetUserId: values.userId, shiftId: shift?.shiftId ?? "" })
      .then((res) => {
        setType("success");
